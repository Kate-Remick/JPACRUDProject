...
<body>
	...
	<div class="indexMain container bg-image" style="background-color: lightgreen; background-image: url('images/sitePhotos/indexBackground.webp'); 
	 background-size: 100% 100%;" >
		<div class="main">
			...
			<p>
				...
				remove members from the family using the links provided on this
				page. <br> Otherwise, you can view the information of one or
				all family members using the form below!
			</p>
			<br>
			...
			<div name="searchByName">
				<form action="getMember.do" method="get">
					<label for="firstName">First Name: </label><input type="text"
						name="firstName" value=""/><br> <label for="lastName">Last
						Name: </label><input type="text" name="lastName" value=""/> <br>
			...
			</a> <a href="addMember.do" method="get">
				<button >Add family member</button>
			</a>
			<form action="editMember.do" method="get">
				<label for="memberToEdit">Select Member:</label> <select
					id="memberToEdit" name="memberToEdit">
