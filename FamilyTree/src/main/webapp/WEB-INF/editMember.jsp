				...
				<c:when test="${editingDetails == true }">
					<form action="editMember.do" method="post">
						<label for="firstName">First Name: </label><input type="text"
							name="firstName" value="${member.firstName }" /><br> <label
							for="lastName">Last Name: </label><input type="text"
							name="lastName" value="${member.lastName }" /> <br>
						...
						<label for="other/unknown">Other/Unknown</label> <input
							type="radio" name="gender" value="other/unknown" /> <br>
						<input type="hidden" name="memberToEditId" value="${member.id }" />
						<input type="hidden" name="imagePath" value="${member.imagePath }" />
						<input type="hidden" name="married" value="${member.married }" />
						<input type="hidden" name="motherId" value="${member.motherId }" />
						<input type="hidden" name="fatherId" value="${member.fatherId }" />
						<input type="hidden" name="spouseId" value="${member.spouseId }" />
						<input type="hidden" name="married" value="${member.married }" />
						<button type="submit">Submit Changes</button>
					</form>
				</c:when>
