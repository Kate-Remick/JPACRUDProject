		...
		<form action="addMember.do" method="post"
			...
			<div name="gender">
				<input type="radio" name="gender"
					...
					type="radio" name="gender" value="female" /><label for="female">Female</label><br><input type="radio"
					name="gender" value="other/unknown" /> <label
					for="other/unknown">Other/Unknown</label><br>
			</div>
			<div name="spouse">
